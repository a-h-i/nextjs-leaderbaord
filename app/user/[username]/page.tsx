...
export default async function Page(props: {
    ...
    return <div>
        ...
        <div className="ms-9">
            <header className="m-6 grid grid-cols-2 w-fit items-center justify-items-start gap-2.5">
                <Avatar
                    img={`https://ipfs.io/ipfs/${searchParams.avatarCid}`}
                    alt={params.username}
                    rounded
                />
                <h1 className="mx-3.5 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{params.username}</h1>
            </header>

            <div>
                <div className="px-8 grid grid-cols-2 w-fit items-center gap-2.5 "><p className="font-bold">Eth Balance:</p>
